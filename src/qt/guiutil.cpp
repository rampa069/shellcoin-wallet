...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Shell.lnk";
}
...
{
    return GetAutostartDir() / "shell.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Shell-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  shell-qt [" + tr("command-line options") + "]                     " + "\n";
