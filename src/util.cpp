...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Shell
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Shell
    // Mac: ~/Library/Application Support/Shell
    // Unix: ~/.shell
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Shell";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "shell.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "shelld.pid"));
