...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 SHELL"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 SHELL"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 SHELL"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 SHELL"));
