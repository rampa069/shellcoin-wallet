...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Shell", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Shell</b> version", 0));
...
"Copyright \302\251 2014 The Shell developers", 0));
